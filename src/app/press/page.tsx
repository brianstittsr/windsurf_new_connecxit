...
export default function PressPage() {
  const pressReleases = [
    ...
    },
    {
      ...
      description:
        "New feature uses machine learning to match event planners with perfect vendors.",
    ...
    },
    {
      ...
      description:
        "Platform now available in major cities across North America.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Get the latest news and updates about ConnecXit&#39;s mission to
            transform the event planning industry.
          </p>
        </div>
            ...
            {pressReleases.map((release) => (
              ...
              >
                ...
                <p className="text-gray-600 mb-4">
                  ConnecXit&rsquo;s innovative platform is revolutionizing the
              ...
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Company information, fact sheets, and FAQs
                  </p>
                </div>
              </div>
