...
export default function GetAppPage() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Get instant notifications about your event planning progress.",
    },
    {
      icon: faMessage,
      title: "Direct Messaging",
      description:
        "Communicate with vendors through our built-in messaging system.",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Plan your events on the go with our powerful mobile app.
