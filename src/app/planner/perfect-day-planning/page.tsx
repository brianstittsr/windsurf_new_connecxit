      ...
      <div className="relative h-[300px] bg-gray-900">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-4xl font-bold text-white mb-4">Perfect Day Planning</h1>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="text-gray-600 mb-6">
                Perfect Day Planning is dedicated to creating seamless, stress-free wedding experiences. 
                Our team excels in custom design, comprehensive vendor coordination, and meticulous 
                budget management. We believe every couple deserves a perfect wedding day, and we work 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center gap-3">
                  <FontAwesomeIcon icon={faPalette} className="w-5 h-5 text-pink-500" />
                  <span>Custom Design</span>
                </div>
                <div className="flex items-center gap-3">
                  <FontAwesomeIcon icon={faHandshake} className="w-5 h-5 text-blue-500" />
            ...
            <section className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="border-l-4 border-gray-200 pl-4">
                ...
                <p className="text-gray-600 italic mb-2">
                  &quot;Working with Perfect Day was the best decision we made. They handled everything 
                  flawlessly and made our day stress-free!&quot; Their vendor recommendations were spot on, 
