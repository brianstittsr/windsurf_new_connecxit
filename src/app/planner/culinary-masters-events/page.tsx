      ...
      <div className="relative h-[300px] bg-gray-900">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-4xl font-bold text-white mb-4">Culinary Masters Events</h1>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="text-gray-600 mb-6">
                Culinary Masters Events brings the fine dining experience to your special occasions. 
                Our team of expert chefs and service professionals specialize in creating 
                unforgettable culinary experiences. We pride ourselves on our custom menus, 
                impeccable presentation, and white-glove service that elevates any event.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-3">
                  <FontAwesomeIcon icon={faUserTie} className="w-5 h-5 text-gray-500" />
            ...
            <section className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">Premium wedding package</p>
                </div>
              </div>
            </section>
            ...
            <section className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="border-l-4 border-gray-200 pl-4">
                ...
                <p className="text-gray-600 italic mb-2">
                  &quot;Culinary Masters exceeded our expectations. The presentation was stunning 
                  and the service was impeccable. Our guests were amazed by the quality and 
                  creativity of each dish.&quot;
                </p>
