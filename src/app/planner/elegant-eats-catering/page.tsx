          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="text-gray-600 mb-6">
                Elegant Eats Catering specializes in creating memorable culinary
                experiences for weddings and special events. Our passion lies in
                crafting exquisite dessert stations, expertly paired wine
                selections, and authentic cultural cuisine that tells your
                unique story through food.
              </p>
            ...
            <section className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="border-l-4 border-gray-200 pl-4">
                ...
                <p className="text-gray-600 italic mb-2">
                  &quot;From the tasting to the wedding day, Elegant Eats was
                  professional and delivered amazing food. The dessert bar was a
                  huge hit! Their attention to detail and willingness to
                  accommodate our cultural preferences made our wedding feast
                  truly special.&quot;
                </p>
