          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="text-gray-600 mb-6">
                Luxe Celebrations is the premier choice for couples seeking an
                extraordinary wedding experience. We specialize in luxury
                weddings, cultural ceremonies, and high-end entertainment
                planning. Our extensive network of premium vendors and unique
                venues allows us to create truly unforgettable celebrations.
              </p>
            ...
            <section className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="border-l-4 border-gray-200 pl-4">
                ...
                <p className="text-gray-600 italic mb-2">
                  &quot;The Luxe team went above and beyond to create our
                  perfect wedding. Their vendor connections and expertise are
                  unmatched!&quot; They seamlessly blended our cultural
