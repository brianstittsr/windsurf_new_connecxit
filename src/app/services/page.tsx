      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="flex justify-between items-start mb-8">
            <div>
              <h1 className="text-2xl font-bold mb-2">Ivy Dream Management Group, LLC</h1>
          ...
          <div className="mb-8">
            ...
            <div className="bg-blue-50 rounded-lg p-6 relative">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-gray-700 mb-4">Background checks are important to customers.</p>
          ...
          <div>
            ...
            <Link href="/targeting-preferences" className="text-blue-500 hover:text-blue-600 block mb-8">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium mb-4">Event Planner and Decorator services</h3>
                <div className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    <FontAwesomeIcon icon={faExclamationTriangle} className="w-5 h-5 text-gray-400 mt-1" />
                    <div>
                      <h4 className="font-medium mb-2">Balloon decorations</h4>
                      <p className="text-gray-600 mb-4">
                        Add targeting preferences to have this service appear in search results and get leads.
                      </p>
                      <button className="text-blue-500 hover:text-blue-600 font-medium">
          ...
          <div className="mt-8 space-y-6">
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <Link href="/business-insights" className="flex items-center justify-between text-blue-500 hover:text-blue-600">
                Business insights
            ...
            <Link href="/pro-rewards" className="flex items-center justify-between bg-white rounded-lg border border-gray-200 p-6 text-blue-500 hover:text-blue-600">
              Pro rewards
              <FontAwesomeIcon icon={faChevronRight} className="w-4 h-4" />
            </Link>
          </div>
