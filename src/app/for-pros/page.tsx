  ...
  const features: Feature[] = [
    {
      ...
      description:
        "Access a large network of potential clients and expand your reach.",
    },
    {
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      quote:
        "ConnecXit has transformed my business. I've seen a 200% increase in bookings since joining.",
      rating: 5,
    },
    {
      name: "Michael Chen",
      ...
      quote:
        "The platform makes it easy to showcase our services and connect with quality clients.",
      rating: 5,
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Join thousands of successful event professionals who trust
                ConnecXit to grow their business.
              </p>
