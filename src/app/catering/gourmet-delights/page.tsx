      ...
      <div className="relative h-[300px] bg-gray-900">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-4xl font-bold text-white mb-4">Gourmet Delights Catering</h1>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="text-gray-600 mb-6">
                Gourmet Delights Catering brings exceptional culinary experiences to your special day. 
                With over 10 years of experience in wedding catering, we specialize in creating 
                personalized menus that reflect your taste and style. Our farm-to-table approach 
                ensures the freshest ingredients, while our international cuisine expertise allows 
                us to craft diverse and exciting menu options.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center gap-3">
                  <FontAwesomeIcon icon={faLeaf} className="w-5 h-5 text-green-500" />
            ...
            <section className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">Average wedding package</p>
                </div>
              </div>
            </section>
            ...
            <section className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="border-l-4 border-gray-200 pl-4">
                ...
                <p className="text-gray-600 italic mb-2">
                  &quot;The food was absolutely incredible! Our guests are still raving about the appetizers 
                  and the main course was cooked to perfection. The service staff was professional 
