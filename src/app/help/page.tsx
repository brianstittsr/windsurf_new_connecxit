    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <section className="mb-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          >
            <FontAwesomeIcon icon={faQuestionCircle} className="text-orange-500 w-6 h-6 mr-3" />
          ...
          <a
            ...
            className="flex items-center p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors"
          >
            <FontAwesomeIcon icon={faBook} className="text-orange-500 w-6 h-6 mr-3" />
            ...
            <div key={idx} className="space-y-4">
              ...
              <div className="space-y-4">
                {category.questions.map((faq, faqIdx) => (
                  <div key={faqIdx} className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                    <h4 className="text-lg font-medium text-gray-900 mb-2">{faq.q}</h4>
      ...
      <section id="contact" className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            <div className="flex items-center mb-4">
              <FontAwesomeIcon icon={faComments} className="text-orange-500 w-6 h-6 mr-3" />
