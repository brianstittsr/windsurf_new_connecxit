...
import { HeartIcon as HeartOutline, ShareIcon, CalendarIcon, MapPinIcon, InformationCircleIcon, CheckIcon } from '@heroicons/react/24/outline';
        ...
        <div className="flex-1">
          ...
          <div className="inline-flex items-center bg-purple-100 rounded-full px-4 py-1 mb-4">
            <div className="flex items-center space-x-2">
              <span className="text-purple-700 text-sm font-medium">Ticket sales end soon</span>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4 mb-8">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <p className="text-gray-600">{organizer.followers} followers</p>
              </div>
            </div>
            <button 
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">{date} · {time} EST</p>
