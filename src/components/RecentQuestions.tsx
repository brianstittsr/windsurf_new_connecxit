...
const questions: Question[] = [
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1551818255-e6e10975bc17?q=80&w=800&auto=format&fit=crop',
    category: 'Marketing',
    author: {
      name: 'Emily Davis',
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-lg leading-8 text-gray-600">
            Learn from our community&apos;s most frequently asked questions about event planning.
          </p>
        </div>
              ...
              <Link href={`/articles/${question.id}`} className="w-full">
                ...
                <div className="max-w-xl">
                  ...
                  <div className="group relative">
                    ...
                    <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">{question.description}</p>
                  </div>
