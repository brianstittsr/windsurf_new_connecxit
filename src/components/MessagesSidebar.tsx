...
import { faInbox, faArchive, faPaperPlane, faStar, faCalendar } from '@fortawesome/free-solid-svg-icons';
import Link from 'next/link';

interface SidebarItem {
  icon: typeof faInbox | typeof faArchive | typeof faPaperPlane | typeof faStar | typeof faCalendar;
  label: string;
  href: string;
  count?: number;
}
...
const sidebarItems: SidebarItem[] = [
  ...
  { icon: faPaperPlane, label: 'Sent quotes', href: '/messages/sent', count: 0 },
    ...
    <div className="w-64 bg-white border-r border-gray-200 h-full">
      <div className="p-4">
          ...
          {sidebarItems.map((item) => (
            ...
            >
              <div className="flex items-center gap-3">
                <FontAwesomeIcon icon={item.icon} className="w-4 h-4 text-gray-500" />
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          >
            Review your availability and<br />
